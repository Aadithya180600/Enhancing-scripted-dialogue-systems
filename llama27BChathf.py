...
def llama2_7b_chat_0_shot(input, model, tokenizer):
...
def llama2_7b_chat_1_shot(input, model, tokenizer):
        for i in input:
...
def llama2_7b_chat_2_shot(input, model, tokenizer):
        for i in input:
...
def llama2_7b_chat_5_shot(input, model, tokenizer):
        for i in input:
                print("Input: ", i)
                print()
...
if len(sys.argv) > 1:
    ...
    llama2_7b_chat_1_shot(args, model, tokenizer)
    llama2_7b_chat_2_shot(args, model, tokenizer)
    llama2_7b_chat_5_shot(args, model, tokenizer)
else:
